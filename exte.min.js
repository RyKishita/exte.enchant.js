...
{initialize:function(a,b,c,e){enchant.Group.call(this);this.x=a;this.y=b;this.width=c;this.height=e;this.fadeOut=this.fadeIn=0.1;this.scrollPx=2;this.lineHeight=10;this.fontSize=this.font=this.color=null;this.wordBreak="break-all";this.stackLimit=0;this._labels=[];this._texts=[];this._currentWork=0;this._fadeOutIndex=this._fadeInIndex=-1;this._scrollNum=0;this._outAllLog=!1;this.addEventListener(enchant.Event.ENTER_FRAME,function(){switch(this._currentWork){case 0:this._outAllLog?0==this._texts.length&&
(this._outAllLog=!1):0<this.stackLimit&&this.stackLimit<=this._texts.length&&(this._outAllLog=!0);if(0<this._texts.length){var a=this._texts.shift();this._fadeInIndex=null;for(var b=0;b<this._labels.length;b++)if(!this._labels[b].visible){this._fadeInIndex=b;break}var c;this._fadeInIndex?(c=this._labels[this._fadeInIndex],c.x=0,c.y=0,c.text=a.text):(c=new enchant.Label(a.text),c.width=this.width,c.visible=!1,this.font&&(c.font=this.font),this.wordBreak&&(c._style.wordBreak=this.wordBreak),this.addChild(c),
this._fadeInIndex=this._labels.length,this._labels.push(c));c._style.fontSize=a.fontSize?a.fontSize:"";c.color=a.color?a.color:"";this._scrollNum=c.height=a.lineHeight;a=0;for(b in this._labels){var e=this._labels[b];e.visible&&(e=e.y+e.height,a<e&&(a=e,this._fadeOutIndex=b))}this._currentWork=this.height<a+c.height?1:2}break;case 1:b=this._labels[this._fadeOutIndex];this._outAllLog||b.opacity<this.fadeOut?(b.opacity=0,b.visible=!1,this._currentWork=2):b.opacity-=this.fadeOut;break;case 2:if(0<this._scrollNum){c=
this._outAllLog?this._scrollNum:this.scrollPx;for(b in this._labels)e=this._labels[b],e.visible&&(e.y+=c);this._scrollNum-=c}0>=this._scrollNum&&(this._currentWork=3,this._labels[this._fadeInIndex].visible=!0);break;case 3:b=this._labels[this._fadeInIndex],this._outAllLog||1-this.fadeIn<b.opacity?(b.opacity=1,this._currentWork=0):b.opacity+=this.fadeIn}})},addLog:function(a,b,c,e){this._texts.push({text:a,color:b||this.color,fontSize:c||this.fontSize,lineHeight:e||this.lineHeight})},outAllLog:function(){this._outAllLog=
!0}}),C=function(){var a=function(d,a,b,c){var e=new Surface(d,a),f=e.context;c?(f.fillStyle=b,f.fillRect(0,0,d,a)):(f.strokeStyle=b,f.strokeRect(0,0,d,a));return e},b=function(d,a,b){var c=new Surface(2*d,2*d),e=c.context,f=e.lineWidth;b?e.fillStyle=a:e.strokeStyle=a;e.beginPath();e.arc(d,d,d-f,0,2*Math.PI,!0);b?e.fill():e.stroke();return c},c=function(d,a,b,c){var e=new Surface(d,a),f=e.context;c?f.fillStyle=b:f.strokeStyle=b;var b=d/2,g=a/2,h=f.lineWidth;f.beginPath();var j=4*(Math.sqrt(2)-1)*
b/3,k=4*(Math.sqrt(2)-1)*g/3;f.moveTo(b,h);f.bezierCurveTo(b+j,h,d-h,g-k,d-h,g);f.bezierCurveTo(d-h,g+k,b+j,a-h,b,a-h);f.bezierCurveTo(b-j,a-h,h,g+k,h,g);f.bezierCurveTo(h,g-k,b-j,h,b,h);c?f.fill():f.stroke();return e},e=enchant.Class.create({initialize:function(d,a){this.x=d||0;this.y=a||0},getDistance:function(d){var a=d.x-this.x,d=d.y-this.y;return Math.sqrt(a*a+d*d)},clone:function(){return new e(this.x,this.y)}}),f=enchant.Class.create({initialize:function(d,a,b,c){this.posS=new e(d,a);this.posE=
new e(b,c)},dx:{get:function(){return this.posE.x-this.posS.x},set:function(d){this.posE.x=this.posS.x+d}},dy:{get:function(){return this.posE.y-this.posS.y},set:function(d){this.posE.y=this.posS.y+d}},length:{get:function(){return this.posS.getDistance(this.posE)},set:function(d){var a=this.Length;this.posE.x=this.posS.x+Math.floor(this.dx*d/a);this.posE.y=this.posS.y+Math.floor(this.dy*d/a)}},isCrossLine:function(d){var a=-this.dy,b=this.dx,c=this.length;0<c&&(c=1/c);var a=a*c,b=b*c,e=d.dx,c=d.dy,
f=a*e+b*c;if(0==f)return!1;a=-(a*d.posS.x+b*d.posS.y+-(this.posS.x*a+this.posS.y*b))/f;if(0>=a||1<a)return!1;b=d.posS.x+e*a;d=d.posS.y+c*a;return 0>(this.posS.x-b)*(this.posE.x-b)+(this.posS.y-d)*(this.posE.y-d)},createSurface:function(d,a){var b,c,e;this.posS.x<this.posE.x==this.posS.y<this.posE.y?(b=0,c=Math.abs(this.dx),e=Math.abs(this.dy)):(b=Math.abs(this.dy),c=Math.abs(this.dx),e=0);var f=new Surface(Math.abs(this.dx),Math.abs(this.dy)),g=f.context;g.strokeStyle=d;g.lineWidth=a||1;g.beginPath();
g.moveTo(0,b);g.lineTo(c,e);g.stroke();return f},createSprite:function(d,a){var b=this.createSurface(d,a),c=new Sprite(b.width,b.height);c.x=Math.min(this.posS.x,this.posE.x);c.y=Math.min(this.posS.y,this.posE.y);c.image=b;return c},clone:function(){return new f(this.posS.x,this.posS.y,this.posE.x,this.posE.y)}}),g=enchant.Class.create({initialize:function(d,a,b,c){this.x=d||0;this.y=a||0;this.width=b||0;this.height=c||0},top:{get:function(){return this.y},set:function(d){this.y=d}},bottom:{get:function(){return this.y+
this.height},set:function(d){this.height=Math.abs(d-this.y);d<this.y&&(this.y=d)}},left:{get:function(){return this.x},set:function(d){this.x=d}},right:{get:function(){return this.x+this.width},set:function(d){this.width=Math.abs(d-this.x);d<this.x&&(this.x=d)}},center:{get:function(){return new e(this.x+this.width/2,this.y+this.height/2)},set:function(d){this.x=d.x-this.width/2;this.y=d.y-this.height/2}},diagonal:{get:function(){return Math.sqrt(this.width*this.width+this.height*this.height)},set:function(d){var a=
this.diagonal;0==a?(d*=Math.sqrt(2),this.x-=Math.floor(0.5*d),this.y-=Math.floor(0.5*d),this.width=this.height=Math.floor(d)):this.scale(d/a)}},scale:function(d,a){"number"!=typeof a&&(a=d);var b=this.width*d,c=this.height*a;this.x+=Math.floor(0.5*(this.width-b));this.y+=Math.floor(0.5*(this.height-c));this.width=Math.floor(b);this.height=Math.floor(c)},updateFrom:function(d){this.x=d.x;this.y=d.y;this.height=d.height*d.scaleX;this.width=d.width},setTo:function(d,a){d.x=this.x;d.y=this.y;a?(d.scaleX=
d.scaleY=1,d.height=this.height,d.width=this.width):(d.scaleX=this.width/d.width,d.scaleY=this.height/d.height)},getPixels:function(d){var d=d.context.getImageData(this.left,this.top,this.width,this.height).data,a=[];a.length=this.height;for(var b=0;b<this.height;b++){a[b]=[];a[b].length=this.width;for(var c=0;c<this.width;c++){var e=4*(b*this.width+c);a[b][c]={r:d[e],g:d[e+1],b:d[e+2],a:d[e+3]}}}return a},clone:function(){return new g(this.x,this.y,this.width,this.height)}}),o=enchant.Class.create(g,
{initialize:function(d,a,b,c){g.call(this,d,a,b,c);this._calcWidth=function(d){return Math.floor(0.5*this.width*((d-1)%3))};this._calcHeight=function(d){return Math.floor(0.5*this.height*(2-Math.floor((d-1)/3)))}},hitTest:function(d){return this.x<d.x&&d.x<this.right&&this.y<d.y&&d.y<this.bottom},intersectRect:function(d){return this.x<d.right&&d.x<this.right&&this.y<d.bottom&&d.y<this.bottom},intersectLine:function(d){return this.hitTest(d.posS)||this.hitTest(d.posE)?!0:this.getSideLine(0).isCross(d)||
this.getSideLine(1).isCross(d)||this.getSideLine(2).isCross(d)||this.getSideLine(3).isCross(d)},getPos:function(d){return new e(this.x+this._calcWidth(d),this.y+this._calcHeight(d))},setPos:function(d,a){this.x=a.x-this._calcWidth(d);this.y=a.y-this._calcHeight(d)},adjustPos:function(d){d.x<this.left?d.x=this.left:this.right<d.x&&(d.x=this.right);d.y<this.top?d.y=this.top:this.bottom<d.y&&(d.y=this.bottom)},getRandomPos:function(){return new e(this.x+Math.floor(Math.random()*this.width),this.y+Math.floor(Math.random()*
this.height))},getSideLine:function(d){var a,b;switch(d){case 0:a=7;b=9;break;case 1:a=1;b=3;break;case 2:a=7;b=1;break;case 3:a=9,b=3}d=new f;d.posS=this.getPos(a);d.posE=this.getPos(b);return d},getDiagonalLine:function(d){var a;switch(d){case 1:a=9;break;case 3:a=7;break;case 7:a=3;break;case 9:a=1}var b=new f;b.posS=this.getPos(d);b.posE=this.getPos(a);return b},createSurface:function(d,b){return a(this.width,this.height,d,b)},createSprite:function(d,a){var b=this.createSurface(d,a),c=new Sprite(b.width,
b.height);c.image=b;c.x=this.x;c.y=this.y;return c},clone:function(){return new o(this.x,this.y,this.width,this.height)}}),i=enchant.Class.create(g,{initialize:function(d,a,b){g.call(this,d-b,a-b,2*b,2*b)},radius:{get:function(){return this.width/2},set:function(d){var a=Math.floor(0.5*(d-this.radius));this.x-=a;this.y-=a;this.width=2*d}},diameter:{get:function(){return this.width},set:function(d){var a=Math.floor(0.5*(d-this.diameter));this.x-=a;this.y-=a;this.width=d}},hitTest:function(d){return this.center.getDistance("Point"==
...
d.z+a[1][3]*d.w,a[2][0]*d.x+a[2][1]*d.y+a[2][2]*d.z+a[2][3]*d.w,a[3][0]*d.x+a[3][1]*d.y+a[3][2]*d.z+a[3][3]*d.w)},composition:function(a){for(var b=this.matrix,c=[],e=0;4>e;e++){c[e]=[];for(var f=0;4>f;f++)for(var g=c[e][f]=0;4>g;g++)c[e][f]+=b[e][g]*a.matrix[g][f]}return new s(c)},compositionMe:function(a){for(var b=this.matrix,c=0;4>c;c++)for(var e=0;4>e;e++){for(var f=0,g=0;4>g;g++)f+=b[g][e]*a.matrix[c][g];this.tmpMat[c][e]=f}for(c=0;4>c;c++)for(e=0;4>e;e++)this.matrix[c][e]=this.tmpMat[c][e]},
...
b);c.keybind(a[0].toLowerCase().charCodeAt(0),b)},toRGBString:function(){var a,b,c,e;3<=arguments.length?(a=arguments[0],b=arguments[1],c=arguments[2],e=4<=arguments.length?arguments[3]:1):1<=arguments.length?(a=b=c=arguments[0],e=2<=arguments.length?arguments[1]:1):a=b=c=e=0;return"rgba("+a+","+b+","+c+","+e+")"},shuffleArray:function(a){for(var b=[];0<a.length;){var c=Math.floor(Math.random()*a.length);b.push(a.splice(c,1)[0])}return b},Event_TimerTimeOut:"Event_TimerTimeout",Timer:z,toKanji1:function(a){return t(a,
"\u3007\u4e00\u4e8c\u4e09\u56db\u4e94\u516d\u4e03\u516b\u4e5d","\u5341\u767e\u5343\u4e07")},toKanji2:function(a){return t(a,"\u96f6\u58f1\u5f10\u53c2\u8086\u4f0d\u9678\u6f06\u634c\u7396","\u62fe\u4f70\u9621\u842c")},degToRad:function(a){return a*Math.PI/180},radToDeg:function(a){return 180*a/Math.PI},normalinzeRad:r,normalinzeDeg:function(a){return 0>a?this.normalinzeDeg(a+360):360<=a?this.normalinzeDeg(a-360):a},makeValues:p,Geolocation:A,collision2Sprites:function(a,b){if(0==a.rotation&&0==b.rotation)return a.intersect(b);
var c=Array(9),e=Array(9);c[0]={X:a.x,Y:a.y};c[1]={X:a.x+a.width,Y:a.y};c[2]={X:a.x+a.width,Y:a.y+a.height};c[3]={X:a.x,Y:a.y+a.height};c[4]={X:a.x,Y:a.y};c[5]={X:a.x+a.width/2,Y:a.y};c[6]={X:a.x+a.width/2,Y:a.y+a.height};c[7]={X:a.x,Y:a.y+a.height/2};c[8]={X:a.x+a.width,Y:a.y+a.height/2};e[0]={X:b.x,Y:b.y};e[1]={X:b.x+b.width,Y:b.y};e[2]={X:b.x+b.width,Y:b.y+b.height};e[3]={X:b.x,Y:b.y+b.height};e[4]={X:b.x,Y:b.y};e[5]={X:b.x+b.width/2,Y:b.y};e[6]={X:b.x+b.width/2,Y:b.y+b.height};e[7]={X:b.x,Y:b.y+
b.height/2};e[8]={X:b.x+b.width,Y:b.y+b.height/2};for(var f in c)c[f].X-=a.x+a.width/2,c[f].Y-=a.y+a.height/2;for(f in e)e[f].X-=b.x+b.width/2,e[f].Y-=b.y+b.height/2;for(f in c){var g=c[f].X,i=c[f].Y;c[f].X=g*Math.cos(a.rotation*Math.PI/180)-i*Math.sin(a.rotation*Math.PI/180);c[f].Y=g*Math.sin(a.rotation*Math.PI/180)+i*Math.cos(a.rotation*Math.PI/180)}for(f in e)g=e[f].X,i=e[f].Y,e[f].X=g*Math.cos(b.rotation*Math.PI/180)-i*Math.sin(b.rotation*Math.PI/180),e[f].Y=g*Math.sin(b.rotation*Math.PI/180)+
i*Math.cos(b.rotation*Math.PI/180);for(f in c)c[f].X+=a.x+a.width/2,c[f].Y+=a.y+a.height/2;for(f in e)e[f].X+=b.x+b.width/2,e[f].Y+=b.y+b.height/2;for(f=0;f<c.length-1;f++)for(g=0;g<e.length-1;g++){var i=(e[g+1].X-e[g].X)*(c[f].Y-e[g].Y)-(e[g+1].Y-e[g].Y)*(c[f].X-e[g].X),l=(e[g+1].X-e[g].X)*(c[f+1].Y-e[g].Y)-(e[g+1].Y-e[g].Y)*(c[f+1].X-e[g].X);if(0>((c[f+1].X-c[f].X)*(e[g].Y-c[f].Y)-(c[f+1].Y-c[f].Y)*(e[g].X-c[f].X))*((c[f+1].X-c[f].X)*(e[g+1].Y-c[f].Y)-(c[f+1].Y-c[f].Y)*(e[g+1].X-c[f].X))&&0>i*l)return!0}return!1},
createMaze:v,setMazeData:function(a,b,c,e,f,g){for(var i=[],l=[],g=v(b,c,g),h=0;h<b;h++){i.push([]);l.push([]);for(var k=0;k<c;k++)i[h].push(e),l[h].push(g[h][k]?f:-1)}a.loadData(i,l);a.collisionData=g},stringWidth:function(a,b){return a.context.measureText(b).width},toKatakanaCase:function(a){for(var b="",c=0;c<a.length;c++)var e=a.charCodeAt(c),b=b+String.fromCharCode(12353<=e&&12438>=e?e+96:e);return b},toHirakanaCase:function(a){for(var b="",c=0;c<a.length;c++)var e=a.charCodeAt(c),b=b+String.fromCharCode(12449<=
e&&12534>=e?e-96:e);return b},randomString:function(a){for(var b="",a=a||1,c=0;c<a;c++)b+="ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz".charAt(Math.floor(49*Math.random()));return b},isOutOfScreen:function(a){var b=enchant.Game.instance;return 0>a.x+a.width||0>a.y+a.height||b.width<a.x||b.height<a.y},round:function(a,b){if("number"==typeof b){var c=Math.pow(10,b);return Math.round(a*c)/c}return Math.round(a)},ceil:function(a,b){if("number"==typeof b){var c=Math.pow(10,b);return Math.ceil(a*
c)/c}return Math.ceil(a)},floor:function(a,b){if("number"==typeof b){var c=Math.pow(10,b);return Math.floor(a*c)/c}return Math.floor(a)},paddingLeft:function(a,b,c){c=c||"0";a=a.toString();for(b-=a.length;0<b--;)a=c+a;return a},paddingRight:function(a,b,c){c=c||"0";a=a.toString();for(b-=a.length;0<b--;)a+=c;return a},formatString:function(a,b){var c=void 0;if("object"==typeof b)c=function(a,c){return b[c]};else var e=arguments,c=function(a,b){return e[parseInt(b)+1]};return a.replace(/\{(\w+)\}/g,
c)},arrayQueryIf:function(a,b){return a.filter(b)},arrayEraseIf:function(a,b){for(var c=a.length-1;0<=c;c--)b(a[c],c,a)&&a.splice(c,1)},samePartsForEach:function(a,b,c,e,f){function g(b,c){for(var g in k){var d=k[g];if(d.row==b&&d.column==c)return}g=a[b][c];(g=f?f(h,g):h==g)&&e(b,c);k.push({row:b,column:c,valid:g})}var i=a.length,l=a[0].length,h=a[b][c],k=[];for(g(b,c);;){var b=null,j;for(j in k)if(k[j].valid){b=k[j];break}if(null==b)break;b.valid=!1;0<b.row&&g(b.row-1,b.column);0<b.column&&g(b.row,
b.column-1);b.row+1<i&&g(b.row+1,b.column);b.column+1<l&&g(b.row,b.column+1)}},findWalkForEach:function(a,b,c,e,f){function g(b,c,e){var f=a[b][c];if(!(e<f)){var e=e-f,d;for(d in h)if(f=h[d],!(f.row!=b||f.column!=c)){f.rest<e&&(f.rest=e,f.valid=!0);return}h.push({row:b,column:c,rest:e,valid:!0})}}var i=a.length,l=a[0].length,h=[];h.push({row:b,column:c,rest:e,valid:!0});for(b=!0;;){var c=null,k;for(k in h)if(h[k].valid){c=h[k];break}if(null==c)break;c.valid=!1;0<c.row&&g(c.row-1,c.column,c.rest);
