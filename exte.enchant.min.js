...
set:function(a){this._opacity=a;this._setOpacityChilds(this,a)},enumerable:!0,configurable:!0});s.prototype.moveSceneTo=function(a){this._nextSceneName=a;this._setFadeOut=!0};d.SceneEx=s;d.addFadeOutText=function(a,c,e,b){void 0!==enchant.util.MutableText&&(c=new M(c.x,c.y),c.text=e,c.fedingValue=1/(enchant.Game.instance.fps*(b||1)),a.addChild(c))};var M,N=enchant.util.MutableText,g=function(a,c){N.call(this,a,c);this.addEventListener(enchant.Event.ENTER_FRAME,function(){this.opacity-=this.fedingValue;
this.opacity<this.fedingValue&&this.parentNode.removeChild(this)})};__extends(g,N);M=g;d.keyBind=function(a,c){var e=enchant.Game.instance;e.keybind(a[0].toUpperCase().charCodeAt(0),c);e.keybind(a[0].toLowerCase().charCodeAt(0),c)};d.Event_TimerTimeOut="Event_TimerTimeout";var O=enchant.Node,g=function(){O.call(this);this._startFrame=this._frame=0;this._active=!1;this._startFrame=this._frame=0;this._active=!1;this.addEventListener(enchant.Event.ENTER_FRAME,function(){this._active&&(this._frame--,
0<this._frame||(enchant.Game.instance.currentScene.dispatchEvent(new enchant.Event(d.Event_TimerTimeOut)),this._frame=this._startFrame))})};__extends(g,O);g.prototype.start=function(a){"number"==typeof a&&(this._frame=this._startFrame=a*enchant.Game.instance.fps);this._active=0<this._startFrame};g.prototype.stop=function(){this._active=!1};d.Timer=g;d.inputToRad=function(){var a=enchant.Game.instance.input;return a.down&&a.right?0.25*Math.PI:a.down&&a.left?0.75*Math.PI:a.up&&a.left?1.25*Math.PI:a.up&&
...
h=c*f+b*d;if(0==h)return!1;c=-(c*a.posS.x+b*a.posS.y+-(this.posS.x*c+this.posS.y*b))/h;if(0>=c||1<c)return!1;b=a.posS.x+f*c;a=a.posS.y+d*c;return 0>(this.posS.x-b)*(this.posE.x-b)+(this.posS.y-a)*(this.posE.y-a)};v.prototype.createSurface=function(a,c){var b,d,f;this.posS.x<this.posE.x==this.posS.y<this.posE.y?(b=0,d=Math.abs(this.dx),f=Math.abs(this.dy)):(b=Math.abs(this.dy),d=Math.abs(this.dx),f=0);var h=new enchant.Surface(Math.abs(this.dx),Math.abs(this.dy)),g=h.context;g.strokeStyle=a;g.lineWidth=
c||1;g.beginPath();g.moveTo(0,b);g.lineTo(d,f);g.stroke();return h};v.prototype.createSprite=function(a,c){var b=this.createSurface(a,c),d=new enchant.Sprite(b.width,b.height);d.x=Math.min(this.posS.x,this.posE.x);d.y=Math.min(this.posS.y,this.posE.y);d.image=b;return d};v.prototype.clone=function(){return new v(this.posS.x,this.posS.y,this.posE.x,this.posE.y)};d.Line=v;var p=function(a,c,b,d){this.x=a||0;this.y=c||0;this.width=b||0;this.height=d||0};Object.defineProperty(p.prototype,"top",{get:function(){return this.y},
set:function(a){this.y=a},enumerable:!0,configurable:!0});Object.defineProperty(p.prototype,"bottom",{get:function(){return this.y+this.height},set:function(a){this.height=Math.abs(a-this.y);a<this.y&&(this.y=a)},enumerable:!0,configurable:!0});Object.defineProperty(p.prototype,"left",{get:function(){return this.x},set:function(a){this.x=a},enumerable:!0,configurable:!0});Object.defineProperty(p.prototype,"right",{get:function(){return this.x+this.width},set:function(a){this.width=Math.abs(a-this.x);
a<this.x&&(this.x=a)},enumerable:!0,configurable:!0});Object.defineProperty(p.prototype,"center",{get:function(){return new u(this.x+this.width/2,this.y+this.height/2)},set:function(a){this.x=a.x-this.width/2;this.y=a.y-this.height/2},enumerable:!0,configurable:!0});Object.defineProperty(p.prototype,"diagonal",{get:function(){return Math.sqrt(this.width*this.width+this.height*this.height)},set:function(a){var c=this.diagonal;0==c?(a*=Math.sqrt(2),this.x-=Math.floor(0.5*a),this.y-=Math.floor(0.5*a),
this.width=this.height=Math.floor(a)):this.scale(a/c)},enumerable:!0,configurable:!0});p.prototype.scale=function(a,c){"number"!=typeof c&&(c=a);var b=this.width*a,d=this.height*c;this.x+=Math.floor(0.5*(this.width-b));this.y+=Math.floor(0.5*(this.height-d));this.width=Math.floor(b);this.height=Math.floor(d)};p.prototype.updateFrom=function(a){this.x=a.x;this.y=a.y;this.height=a.height*a.scaleX;this.width=a.width};p.prototype.setTo=function(a,c){a.x=this.x;a.y=this.y;c?(a.scaleX=a.scaleY=1,a.height=
this.height,a.width=this.width):(a.scaleX=this.width/a.width,a.scaleY=this.height/a.height)};p.prototype.getPixels=function(a){var a=a.context.getImageData(this.left,this.top,this.width,this.height).data,c=[];c.length=this.height;for(var b=0;b<this.height;b++){c[b]=[];c[b].length=this.width;for(var d=0;d<this.width;d++){var f=4*(b*this.width+d);c[b][d]={r:a[f],g:a[f+1],b:a[f+2],a:a[f+3]}}}return c};p.prototype.clone=function(){return new p(this.x,this.y,this.width,this.height)};d.Area=p;var q=function(a,
c,b,d){p.call(this,a,c,b,d)};__extends(q,p);q.prototype._calcWidth=function(a){return Math.floor(0.5*this.width*((a-1)%3))};q.prototype._calcHeight=function(a){return Math.floor(0.5*this.height*(2-Math.floor((a-1)/3)))};q.prototype.hitTest=function(a){return this.x<a.x&&a.x<this.right&&this.y<a.y&&a.y<this.bottom};q.prototype.intersectRect=function(a){return this.x<a.right&&a.x<this.right&&this.y<a.bottom&&a.y<this.bottom};q.prototype.intersectLine=function(a){return this.hitTest(a.posS)||this.hitTest(a.posE)?
!0:this.getSideLine(0).isCross(a)||this.getSideLine(1).isCross(a)||this.getSideLine(2).isCross(a)||this.getSideLine(3).isCross(a)};q.prototype.getPos=function(a){return new u(this.x+this._calcWidth(a),this.y+this._calcHeight(a))};q.prototype.setPos=function(a,c){this.x=c.x-this._calcWidth(a);this.y=c.y-this._calcHeight(a)};q.prototype.adjustPos=function(a){a.x<this.left?a.x=this.left:this.right<a.x&&(a.x=this.right);a.y<this.top?a.y=this.top:this.bottom<a.y&&(a.y=this.bottom)};q.prototype.getRandomPos=
function(){return new u(this.x+b(this.width),this.y+b(this.height))};q.prototype.getSideLine=function(a){var c,b;switch(a){case 0:c=7;b=9;break;case 1:c=1;b=3;break;case 2:c=7;b=1;break;case 3:c=9,b=3}a=new v(0,0,0,0);a.posS=this.getPos(c);a.posE=this.getPos(b);return a};q.prototype.getDiagonalLine=function(a){var c;switch(a){case 1:c=9;break;case 3:c=7;break;case 7:c=3;break;case 9:c=1}var b=new v(0,0,0,0);b.posS=this.getPos(a);b.posE=this.getPos(c);return b};q.prototype.createSurface=function(a,
c){return y(this.width,this.height,a,c)};q.prototype.createSprite=function(a,c){var b=this.createSurface(a,c),d=new enchant.Sprite(b.width,b.height);d.image=b;d.x=this.x;d.y=this.y;return d};q.prototype.clone=function(){return new q(this.x,this.y,this.width,this.height)};d.Rectangle=q;var m=function(a,c,b){p.call(this,a-b,c-b,2*b,2*b)};__extends(m,p);Object.defineProperty(m.prototype,"radius",{get:function(){return this.width/2},set:function(a){var c=Math.floor(0.5*(a-this.radius));this.x-=c;this.y-=
c;this.width=2*a},enumerable:!0,configurable:!0});Object.defineProperty(m.prototype,"diameter",{get:function(){return this.width},enumerable:!0,configurable:!0});m.prototype.set=function(a){var c=Math.floor(0.5*(a-this.diameter));this.x-=c;this.y-=c;this.width=a};m.prototype.hitTest=function(a){return this.center.getDistance(a)<this.radius};m.prototype.intersectRect=function(){throw Error("Circle.intersectRect is not implemented");};m.prototype.intersectLine=function(){throw Error("Circle.intersectLine is not implemented");
};m.prototype.intersectCircle=function(a){var c=(this.diameter+a.diameter)/2,b;return(b=this.x-a.x+(this.width-a.width)/2)*b+(b=this.y-a.y+(this.height-a.height)/2)*b<c*c};m.prototype.adjustPos=function(a){var c=this.center.getDistance(a);if(!(c<this.radius)){var b=this.center;a.x=b.x+Math.floor(this.radius*(a.x-b.x)/c);a.y=b.y+Math.floor(this.radius*(a.y-b.y)/c)}};m.prototype.getRandomPos=function(){var a=Math.random()*this.radius,c=2*Math.random()*Math.PI,b=this.center;b.x+=Math.floor(Math.cos(c)*
a);b.y+=Math.floor(Math.sin(c)*a);return b};m.prototype.createSurface=function(a,c){return z(this.radius,a,c)};m.prototype.createSprite=function(a,c){var b=this.createSurface(a,c),d=new enchant.Sprite(b.width,b.height);d.image=b;d.x=this.x;d.y=this.y;return d};m.prototype.clone=function(){var a=this.center;return new m(a.x,a.y,this.radius)};d.Circle=m;var w=function(a,c,b,d){p.call(this,a-b/2,c-d/2,b,d)};__extends(w,p);w.prototype.hitTest=function(){throw Error("Ellipse.hitTest is not implemented");
};w.prototype.intersectRect=function(){throw Error("Ellipse.intersectRect is not implemented");};w.prototype.intersectLine=function(){throw Error("Ellipse.intersectLine is not implemented");};w.prototype.adjustPos=function(){throw Error("Ellipse.adjustPos is not implemented");};w.prototype.getRandomPos=function(){throw Error("Ellipse.getRandomPos is not implemented");};w.prototype.createSurface=function(a,c){return C(this.width,this.height,a,c)};w.prototype.createSprite=function(a,c){var b=this.createSurface(a,
c),d=new enchant.Sprite(b.width,b.height);d.image=b;d.x=this.x;d.y=this.y;return d};w.prototype.clone=function(){var a=this.center;return new w(a.x,a.y,this.width,this.height)};d.Ellipse=w;var r=function(a,c,b,d,f){m.call(this,a,c,b);this.angle=j(d|0);this.range=j(f|0)};__extends(r,m);Object.defineProperty(r.prototype,"angleStart",{get:function(){return j(this.angle-0.5*this.range)},enumerable:!0,configurable:!0});Object.defineProperty(r.prototype,"angleEnd",{get:function(){return j(this.angle+0.5*
this.range)},enumerable:!0,configurable:!0});r.prototype.hitTest=function(){throw Error("Arc.hitTest is not implemented");};r.prototype.intersectRect=function(){throw Error("Arc.intersectRect is not implemented");};r.prototype.intersectLine=function(){throw Error("Arc.intersectLine is not implemented");};r.prototype.intersectCircle=function(){throw Error("Arc.intersectCircle is not implemented");};r.prototype.adjustPos=function(){throw Error("Arc.adjustPos is not implemented");};r.prototype.getRandomPos=
function(){var a=Math.random()*this.radius,c=this.angle+Math.random()*this.range-0.5*this.range,b=this.center;b.x+=Math.floor(Math.cos(c)*a);b.y+=Math.floor(Math.sin(c)*a);return b};r.prototype.createSurface=function(a,b){return D(this.radius,this.angle,this.range,a,b)};r.prototype.createSprite=function(a,b){var e=this.createSurface(a,b),d=new enchant.Sprite(e.width,e.height);d.image=e;d.x=this.x;d.y=this.y;return d};r.prototype.clone=function(){var a=this.center;return new r(a.x,a.y,this.radius,
this.angle,this.range)};d.Arc=r;var Q=enchant.Sprite,g=function(a,b){Q.call(this,a,b);this._active=!1;this._radiusLimit=this._radiusMax=this._radius=0;this._speed=1;this.image=new enchant.Surface(a,b);this.addEventListener(enchant.Event.ENTER_FRAME,function(){this._active&&(this._radius+=this._speed,this._radius<this._radiusMax?this._draw():this.stop())})};__extends(g,Q);g.prototype._draw=function(){var a=this.image.context;a.fillStyle="transparent";this.image.clear();a.beginPath();a.arc(this._center.x,
this._center.y,this._radius,0,2*Math.PI,!1);a.closePath();a.stroke()};Object.defineProperty(g.prototype,"lineColor",{get:function(){return this.image.context.strokeStyle},enumerable:!0,configurable:!0});g.prototype.set=function(a){this.image.context.strokeStyle=a};Object.defineProperty(g.prototype,"lineWidth",{get:function(){return this.image.context.lineWidth},set:function(a){this.image.context.lineWidth=a},enumerable:!0,configurable:!0});Object.defineProperty(g.prototype,"speed",{get:function(){return this._speed},
set:function(a){this._speed=a},enumerable:!0,configurable:!0});Object.defineProperty(g.prototype,"radius",{get:function(){return this._radius},enumerable:!0,configurable:!0});Object.defineProperty(g.prototype,"radiusMax",{get:function(){return this._radiusMax},enumerable:!0,configurable:!0});Object.defineProperty(g.prototype,"radiusLimit",{get:function(){return this._radiusLimit},set:function(a){this._radiusLimit=a},enumerable:!0,configurable:!0});g.prototype.start=function(a,b){this._center=new u(a,
b);this._active=!0;this._radius=0;this._radiusMax=0<this._radiusLimit?this._radiusLimit:this._center.getDistance(new u(this.width/2<a?0:this.width,this.height/2<b?0:this.height));this.image.clear()};Object.defineProperty(g.prototype,"active",{get:function(){return this._active},set:function(a){this._active!=a&&!(a&&0==this._radiusMax)&&(this._active=a)},enumerable:!0,configurable:!0});g.prototype.stop=function(){this._active=!1;this._radiusMax=0;this.image.clear()};d.Ripple=g;d.pushWaitScene=function(a,
b){var e=enchant.Game.instance,d=new enchant.Scene;if(b){var f=new enchant.Sprite(b.width,b.height);f.x=(e.width-b.width)/2;f.y=(e.height-b.height)/2;f.image=b;d.addChild(f)}d.addEventListener(enchant.Event.ENTER_FRAME,function(){a()&&e.popScene()});e.pushScene(d)};d.http2str=function(a){try{var b=new XMLHttpRequest;b.open("GET",a,!1);b.send(null);if(200==b.status||0==b.status)return b.responseText}catch(e){}return null}})(exte||(exte={}));
